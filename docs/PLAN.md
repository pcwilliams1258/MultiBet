...
| INFRA-4 | **As a developer**, I want a local, automated quality gateway so that I can get instant feedback on code formatting and linting. | #82 | 📋 Planned | High | @copilot | Delegated | enhancement, ci-cd, infra |
