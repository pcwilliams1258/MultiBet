...
| INFRA-5 | **As a project maintainer**, I want a single, efficient CI/CD workflow so that I can have a definitive, centralized authority on code quality. | #83 | 📋 Planned | Critical | @copilot | Delegated | refactor, ci-cd, testing, infra |
